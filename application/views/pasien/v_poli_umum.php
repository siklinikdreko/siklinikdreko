...
<div class="container">
  <h2>Form Keluhan Poli Umum</h2>
  <form action="<?php echo base_url('pasien/keluhan_poli_umum')?>" method="post">
    ...
    <div class="form-group">
      ...
      <textarea name="keluhan" cols="50" maxlength="100" rows="5" class="form-control" required></textarea>
    </div>
    <div class="form-group">
