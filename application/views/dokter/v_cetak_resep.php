...
<head>
  ...
  <meta http-equiv="refresh" content="2; url=<?php echo base_url('dokter');?>">
...
<div class="container">
  <h2>Form Keluhan Pasien Pasien Poli <?php echo $data['poli'];?> Klinik Dr.Eko</h2>
  <form action="<?php echo base_url('dokter/buat_resep')?>" method="post">
    ...
    <div class="form-group">
      ...
      <textarea name="resep_obat" cols="50" rows="5" class="form-control" readonly><?php echo $data['resep_obat']; ?></textarea>
    </div>
  </form>
</div>
